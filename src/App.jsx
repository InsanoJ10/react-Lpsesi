  ...
  return (
    <>
      ...
      <span className={s.navItems} onClick={() => navTo("s2")}>
        ...
        <a href='#s2' className={s.navWords}>Jogos</a>
      </span>
  ...
  <div class="container-fluid">
    ...
    <main>
      <section className={s.s1} id="s1">
        <h1>DOOM</h1>
        <h2>Best boomer shooter of all times.</h2>
      </section>
      ...
      <section className={s.s3} id="s3">
        <iframe width="3000" height="1000" 
        src="https://www.youtube.com/embed/63DixqMTG8Y?si=o_40M242Ni2GoYtU&autoplay-0&" 
